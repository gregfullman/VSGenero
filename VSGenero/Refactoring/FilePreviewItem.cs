...
namespace VSGenero.Refactoring
{
    ...
    class FilePreviewItem : IPreviewItem
    {
        ...
        public void DisplayPreview(IVsTextView view)
        {
            ...
            if (buffer.Properties.ContainsProperty(typeof(GeneroProjectAnalyzer)))
            {
                buffer.Properties.RemoveProperty(typeof(GeneroProjectAnalyzer));
            }
            buffer.Properties.AddProperty(typeof(GeneroProjectAnalyzer), this.Engine._analyzer);
