...
namespace VSGenero.Analysis
{
    ...
    {
        private readonly GeneroAnalyzer _analyzer;
        private readonly ConcurrentDictionary<IGeneroModule, BuiltinModule> _builtinModuleTable = new ConcurrentDictionary<IGeneroModule, BuiltinModule>();
        ...
        public ModuleTable(GeneroAnalyzer analyzer)
        {
            _analyzer = analyzer;
        }
        ...
        internal BuiltinModule GetBuiltinModule(IGeneroModule attr)
        {
            if (attr == null)
            {
                return null;
        ...
        class UnresolvedModuleLoadState : ModuleLoadState
        {
            ...
            public override GeneroMemberType MemberType
            {
                get { return GeneroMemberType.Unknown; }
            }
        ...
        class UninitializedModuleLoadState : ModuleLoadState
        {
            ...
            private GeneroMemberType? _type;
        ...
        class InitializedModuleLoadState : ModuleLoadState
        {
            ...
            public override GeneroMemberType MemberType
            {
                get
                {
                    ...
                    return GeneroMemberType.Module;
                }
            }
        ...
        private static bool IsExcludedBuiltin(IPythonModule builtin, IMember mem)
        {
            ...
            if (mem is IPythonModule || // modules are handled specially
                ...
                ((constant = mem as IPythonConstant) != null && constant.Type.TypeId == BuiltinTypeId.Object))
