...
namespace VSGenero.Analysis.Parsing
{
    ...
    {
        public static TokenNameCiComparer CaseInsensitiveNameComparer = new TokenNameCiComparer();
    ...
    {
        int Compare(TokenWithSpan x, TokenWithSpan y)
        {
            return StringComparer.OrdinalIgnoreCase.Compare(x.Token.Value.ToString(), y.Token.Value.ToString());
        }

        public bool Equals(TokenWithSpan x, TokenWithSpan y)
        {
            return StringComparer.OrdinalIgnoreCase.Equals(x.Token.Value.ToString(), y.Token.Value.ToString());
        }

        public int GetHashCode(TokenWithSpan obj)
        {
            return StringComparer.OrdinalIgnoreCase.GetHashCode(obj.Token.Value.ToString());
        }

        int IComparer<TokenWithSpan>.Compare(TokenWithSpan x, TokenWithSpan y)
        {
            return StringComparer.OrdinalIgnoreCase.Compare(x.Token.Value.ToString(), y.Token.Value.ToString());
        }
    }
    ...
    internal class IncompleteMultiLineCommentErrorToken : ErrorToken
    {
        private readonly string _value;

        public IncompleteMultiLineCommentErrorToken(string message, string value)
            : base(message, value)
        {
            _value = value;
        }
