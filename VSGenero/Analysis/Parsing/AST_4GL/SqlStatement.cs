...
namespace VSGenero.Analysis.Parsing.AST_4GL
{
                                ...
                                if (!parser.PeekToken(TokenKind.Comma))
                                {
                                    ...
                                    if ((cat == TokenCategory.Keyword ||
                                       cat == TokenCategory.Identifier) &&
                                        (!Genero4glAst.ValidStatementKeywords.Contains(peek.Kind) &&
    ...
    {
        public static bool TryParseNode(Genero4glParser parser, out AlterStatement node)
        {
            node = null;
            bool result = false;
    ...
    {
        public static bool TryParseNode(Genero4glParser parser, out DropStatement node)
        {
            node = null;
            bool result = false;
    ...
    {
        public static bool TryParseNode(Genero4glParser parser, out RenameStatement node)
        {
            node = null;
            bool result = false;
