...
namespace VSGenero.Analysis.Parsing.AST_4GL
{
    ...
    public class PromptDisplayAttribute : AstNode4gl
    {
    ...
    public class PromptControlAttribute : AstNode4gl
    {
        public static bool TryParseNode(Genero4glParser parser, out PromptControlAttribute node)
        {
